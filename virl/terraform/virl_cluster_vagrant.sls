...
virl_cluster repo:
  git.latest:
    ...
    - target: /home/vagrant/virl_cluster
...
cluster pem minion key copy:
  file.copy:
    - name: /home/vagrant/virl_cluster/keys/minion.pem
...
cluster pub minion key copy:
  file.copy:
    - name: /home/vagrant/virl_cluster/keys/minion.pub
...
cluster sign minion key copy:
  file.copy:
    - name: /home/vagrant/virl_cluster/keys/master_sign.pub
...
cluster working variable file:
  file.copy:
    - user: vagrant
    - group: vagrant
    - name: /home/vagrant/virl_cluster/variables.tf
    - source: /home/vagrant/virl_cluster/variables.tf.orig
    - force: true
...
cluster working password file:
  file.copy:
    - user: vagrant
    - group: vagrant
    - name: /home/vagrant/virl_cluster/passwords.tf
    - source: /home/vagrant/virl_cluster/passwords.tf.orig
    - force: true
...
cluster working api file:
  file.copy:
    - user: vagrant
    - group: vagrant
    - name: /home/vagrant/virl_cluster/settings.tf
    - source: /home/vagrant/virl_cluster/settings.tf.orig
    - force: false
...
cluster variables tf backup ownership fix:
  file.managed:
    - name: /home/vagrant/virl_cluster/variables.tf.bak
    - create: false
    - user: vagrant
    - group: vagrant
...
cluster passwords tf backup ownership fix:
  file.managed:
    - name: /home/vagrant/virl_cluster/passwords.tf.bak
    - create: false
    - user: vagrant
    - group: vagrant
