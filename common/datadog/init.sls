# near total ripoff of datadog saltstack formula found here https://github.com/DataDog/datadog-formula
# all credit to those folks
...
datadog-network-replace:
  file.managed:
    - name: /etc/dd-agent/conf.d/network.yaml
    - source: salt://common/datadog/files/network.yaml
    - watch:
      - pkg: datadog-pkg
